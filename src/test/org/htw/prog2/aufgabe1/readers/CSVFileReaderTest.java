...
class CSVFileReaderTest {
    ...
    void constructor_wrongHeaderStart() {
        assertThrows(FileFormatException.class, () -> {
            new CSVFileReader().readFile("/Users/maxgoricke/IdeaProjects/Template-Programmieren2-Aufgabe4/data/HIVMutationPatterns_wrongHeader.csv");
        });
    }
    ...
    void constructor_wrongHeaderDrugnames() {
        assertThrows(FileFormatException.class, () -> {
            new CSVFileReader().readFile("/Users/maxgoricke/IdeaProjects/Template-Programmieren2-Aufgabe4/data/HIVMutationPatterns_wrongHeader2.csv");
        });
    }
    ...
    void constructor_columnNumbers() {
        assertThrows(FileFormatException.class, () -> {
            new CSVFileReader().readFile("/Users/maxgoricke/IdeaProjects/Template-Programmieren2-Aufgabe4/data/HIVMutationPatterns_wrongElementNumber.csv");
        });
    }
    ...
    void constructor_correctFile() {
        assertDoesNotThrow(() -> {
            new CSVFileReader().readFile("/Users/maxgoricke/IdeaProjects/Template-Programmieren2-Aufgabe4/data/HIVMutationPatternsPI.csv");
        });
    }
    ...
    void getNumberOfMutations() {
        assertDoesNotThrow(() -> {
            MutationFile patterns = new CSVFileReader().readFile("/Users/maxgoricke/IdeaProjects/Template-Programmieren2-Aufgabe4/data/HIVMutationPatternsPI.csv");
