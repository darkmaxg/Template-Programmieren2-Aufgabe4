...
class ReaderManagerTest {
    ...
    void correctFormat_getReaderForFile() {
        ...
        manager.addReader(new FASTAFileReader());
        manager.addReader(new FASTQFileReader());
        assertDoesNotThrow(() -> { manager.getReaderForFile("/Users/maxgoricke/IdeaProjects/Template-Programmieren2-Aufgabe4/data/protease_sequences.fastq"); });
        try {
            SequenceFileReader reader = manager.getReaderForFile("/Users/maxgoricke/IdeaProjects/Template-Programmieren2-Aufgabe4/data/protease_sequences.fastq");
